...
// Rx & Tx LEDs, changed to other pins
#define TX_RX_LED_INIT	DDRF |= (1<<0), DDRF |= (1<<1)
#define TXLED0			PORTF |= (1<<0)
#define TXLED1			PORTF &= ~(1<<0)
#define RXLED0			PORTF |= (1<<1)
#define RXLED1			PORTF &= ~(1<<1)
